"""
Django settings for uhhffn_215 project.
...
WSGI_APPLICATION = 'uhhffn_215.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "uhhffn_215 API",
    "DESCRIPTION": "API documentation for uhhffn_215 App",
    "VERSION": "v1",
}
